...
static ACVP_RESULT acvp_parse_session_info_file(ACVP_CTX *ctx,
                                                const char *filename);
...
static ACVP_RESULT acvp_get_result_test_session(ACVP_CTX *ctx,
                                                char *session_url);
 ...
 */
ACVP_ALG_HANDLER alg_tbl[ACVP_ALG_MAX] = {{ACVP_AES_GCM,
                                           &acvp_aes_kat_handler,
                                           ACVP_ALG_AES_GCM,
                                           NULL,
                                           ACVP_REV_AES_GCM,
                                           {ACVP_SUB_AES_GCM}},
                                          {ACVP_AES_GCM_SIV,
                                           &acvp_aes_kat_handler,
                                           ACVP_ALG_AES_GCM_SIV,
                                           NULL,
                                           ACVP_REV_AES_GCM_SIV,
                                          ...
                                          {ACVP_AES_CBC_CS1,
                                           &acvp_aes_kat_handler,
                                           ACVP_ALG_AES_CBC_CS1,
                                           NULL,
                                           ACVP_REV_AES_CBC_CS1,
                                           {ACVP_SUB_AES_CBC_CS1}},
                                          {ACVP_AES_CBC_CS2,
                                           &acvp_aes_kat_handler,
                                           ACVP_ALG_AES_CBC_CS2,
                                           NULL,
                                           ACVP_REV_AES_CBC_CS2,
                                           {ACVP_SUB_AES_CBC_CS2}},
                                          {ACVP_AES_CBC_CS3,
                                           &acvp_aes_kat_handler,
                                           ACVP_ALG_AES_CBC_CS3,
                                           NULL,
                                           ACVP_REV_AES_CBC_CS3,
                                          ...
                                          {ACVP_TDES_CFBP64,
                                           &acvp_des_kat_handler,
                                           ACVP_ALG_TDES_CFBP64,
                                           NULL,
                                           ACVP_REV_TDES_CFBP64,
                                          ...
                                          {ACVP_RSA_KEYGEN,
                                           ...
                                           {ACVP_SUB_RSA_KEYGEN}},
                                          {ACVP_RSA_SIGGEN,
                                           &acvp_rsa_siggen_kat_handler,
                                           ACVP_ALG_RSA,
                                           ACVP_MODE_SIGGEN,
                                           ACVP_REV_RSA,
                                           {ACVP_SUB_RSA_SIGGEN}},
                                          {ACVP_RSA_SIGVER,
                                           &acvp_rsa_sigver_kat_handler,
                                           ACVP_ALG_RSA,
                                           ACVP_MODE_SIGVER,
                                           ACVP_REV_RSA,
                                           {ACVP_SUB_RSA_SIGVER}},
                                          {ACVP_RSA_DECPRIM,
                                           &acvp_rsa_decprim_kat_handler,
                                           ACVP_ALG_RSA,
                                           ACVP_MODE_DECPRIM,
                                           ACVP_REV_RSA_DECPRIM,
                                           {ACVP_SUB_RSA_DECPRIM}},
                                          {ACVP_RSA_SIGPRIM,
                                           &acvp_rsa_sigprim_kat_handler,
                                           ACVP_ALG_RSA,
                                           ACVP_MODE_SIGPRIM,
                                           ACVP_REV_RSA_SIGPRIM,
                                           {ACVP_SUB_RSA_SIGPRIM}},
                                          {ACVP_ECDSA_KEYGEN,
                                           &acvp_ecdsa_keygen_kat_handler,
                                           ACVP_ALG_ECDSA,
                                           ACVP_MODE_KEYGEN,
                                           ACVP_REV_ECDSA,
                                           {ACVP_SUB_ECDSA_KEYGEN}},
                                          {ACVP_ECDSA_KEYVER,
                                           &acvp_ecdsa_keyver_kat_handler,
                                           ACVP_ALG_ECDSA,
                                           ACVP_MODE_KEYVER,
                                           ACVP_REV_ECDSA,
                                           {ACVP_SUB_ECDSA_KEYVER}},
                                          {ACVP_ECDSA_SIGGEN,
                                           &acvp_ecdsa_siggen_kat_handler,
                                           ACVP_ALG_ECDSA,
                                           ACVP_MODE_SIGGEN,
                                           ACVP_REV_ECDSA,
                                           {ACVP_SUB_ECDSA_SIGGEN}},
                                          {ACVP_ECDSA_SIGVER,
                                           &acvp_ecdsa_sigver_kat_handler,
                                           ACVP_ALG_ECDSA,
                                           ACVP_MODE_SIGVER,
                                           ACVP_REV_ECDSA,
                                           {ACVP_SUB_ECDSA_SIGVER}},
                                          {ACVP_DET_ECDSA_SIGGEN,
                                           &acvp_det_ecdsa_siggen_kat_handler,
                                           ACVP_ALG_DET_ECDSA,
                                           ACVP_MODE_SIGGEN,
                                           ACVP_REV_ECDSA,
                                           {ACVP_SUB_DET_ECDSA_SIGGEN}},
                                          {ACVP_KDF135_SNMP,
                                           &acvp_kdf135_snmp_kat_handler,
                                           ACVP_KDF135_ALG_STR,
                                           ACVP_ALG_KDF135_SNMP,
                                           ACVP_REV_KDF135_SNMP,
                                           {ACVP_SUB_KDF_SNMP}},
                                          {ACVP_KDF135_SSH,
                                           &acvp_kdf135_ssh_kat_handler,
                                           ACVP_KDF135_ALG_STR,
                                           ACVP_ALG_KDF135_SSH,
                                           ACVP_REV_KDF135_SSH,
                                           {ACVP_SUB_KDF_SSH}},
                                          {ACVP_KDF135_SRTP,
                                           &acvp_kdf135_srtp_kat_handler,
                                           ACVP_KDF135_ALG_STR,
                                           ACVP_ALG_KDF135_SRTP,
                                           ACVP_REV_KDF135_SRTP,
                                           {ACVP_SUB_KDF_SRTP}},
                                          {ACVP_KDF135_IKEV2,
                                           &acvp_kdf135_ikev2_kat_handler,
                                           ACVP_KDF135_ALG_STR,
                                           ACVP_ALG_KDF135_IKEV2,
                                           ACVP_REV_KDF135_IKEV2,
                                           {ACVP_SUB_KDF_IKEV2}},
                                          {ACVP_KDF135_IKEV1,
                                           &acvp_kdf135_ikev1_kat_handler,
                                           ACVP_KDF135_ALG_STR,
                                           ACVP_ALG_KDF135_IKEV1,
                                           ACVP_REV_KDF135_IKEV1,
                                           {ACVP_SUB_KDF_IKEV1}},
                                          {ACVP_KDF135_X942,
                                           &acvp_kdf135_x942_kat_handler,
                                           ACVP_KDF135_ALG_STR,
                                           ACVP_ALG_KDF135_X942,
                                           ACVP_REV_KDF135_X942,
                                           {ACVP_SUB_KDF_X942}},
                                          {ACVP_KDF135_X963,
                                           &acvp_kdf135_x963_kat_handler,
                                           ACVP_KDF135_ALG_STR,
                                           ACVP_ALG_KDF135_X963,
                                           ACVP_REV_KDF135_X963,
                                           {ACVP_SUB_KDF_X963}},
                                          {ACVP_KDF108,
                                           &acvp_kdf108_kat_handler,
                                           ACVP_ALG_KDF108,
                                           NULL,
                                           ACVP_REV_KDF108,
                                           {ACVP_SUB_KDF_108}},
                                          {ACVP_PBKDF,
                                           &acvp_pbkdf_kat_handler,
                                           ACVP_ALG_PBKDF,
                                           NULL,
                                           ACVP_REV_PBKDF,
                                           {ACVP_SUB_KDF_PBKDF}},
                                          {ACVP_KDF_TLS12,
                                           &acvp_kdf_tls12_kat_handler,
                                           ACVP_ALG_TLS12,
                                           ACVP_ALG_KDF_TLS12,
                                           ACVP_REV_KDF_TLS12,
                                           {ACVP_SUB_KDF_TLS12}},
                                          {ACVP_KDF_TLS13,
                                           &acvp_kdf_tls13_kat_handler,
                                           ACVP_ALG_TLS13,
                                           ACVP_ALG_KDF_TLS13,
                                           ACVP_REV_KDF_TLS13,
                                           {ACVP_SUB_KDF_TLS13}},
                                          {ACVP_KAS_ECC_CDH,
                                           &acvp_kas_ecc_kat_handler,
                                           ACVP_ALG_KAS_ECC,
                                           ACVP_ALG_KAS_ECC_CDH,
                                           ACVP_REV_KAS_ECC,
                                           {ACVP_SUB_KAS_ECC_CDH}},
                                          {ACVP_KAS_ECC_COMP,
                                           &acvp_kas_ecc_kat_handler,
                                           ACVP_ALG_KAS_ECC,
                                           ACVP_ALG_KAS_ECC_COMP,
                                           ACVP_REV_KAS_ECC,
                                           {ACVP_SUB_KAS_ECC_COMP}},
                                          {ACVP_KAS_ECC_NOCOMP,
                                           &acvp_kas_ecc_kat_handler,
                                           ACVP_ALG_KAS_ECC,
                                           ACVP_ALG_KAS_ECC_NOCOMP,
                                           ACVP_REV_KAS_ECC,
                                           {ACVP_SUB_KAS_ECC_NOCOMP}},
                                          {ACVP_KAS_ECC_SSC,
                                           &acvp_kas_ecc_ssc_kat_handler,
                                           ACVP_ALG_KAS_ECC_SSC,
                                           ACVP_ALG_KAS_ECC_COMP,
                                           ACVP_REV_KAS_ECC_SSC,
                                           {ACVP_SUB_KAS_ECC_SSC}},
                                          {ACVP_KAS_FFC_COMP,
                                           &acvp_kas_ffc_kat_handler,
                                           ACVP_ALG_KAS_FFC,
                                           ACVP_ALG_KAS_FFC_COMP,
                                           ACVP_REV_KAS_FFC,
                                           {ACVP_SUB_KAS_FFC_COMP}},
                                          {ACVP_KAS_FFC_NOCOMP,
                                           &acvp_kas_ffc_kat_handler,
                                           ACVP_ALG_KAS_FFC,
                                           ACVP_ALG_KAS_FFC_NOCOMP,
                                           ACVP_REV_KAS_FFC,
                                           {ACVP_SUB_KAS_FFC_NOCOMP}},
                                          {ACVP_KAS_FFC_SSC,
                                           &acvp_kas_ffc_ssc_kat_handler,
                                           ACVP_ALG_KAS_FFC_SSC,
                                           ACVP_ALG_KAS_FFC_COMP,
                                           ACVP_REV_KAS_FFC_SSC,
                                           {ACVP_SUB_KAS_FFC_SSC}},
                                          {ACVP_KAS_IFC_SSC,
                                           &acvp_kas_ifc_ssc_kat_handler,
                                           ACVP_ALG_KAS_IFC_SSC,
                                           ACVP_ALG_KAS_IFC_COMP,
                                           ACVP_REV_KAS_IFC_SSC,
                                           {ACVP_SUB_KAS_IFC_SSC}},
                                          {ACVP_KDA_ONESTEP,
                                           &acvp_kda_onestep_kat_handler,
                                           ACVP_ALG_KDA_ALG_STR,
                                           ACVP_ALG_KDA_ONESTEP,
                                           ACVP_REV_KDA_ONESTEP,
                                           {ACVP_SUB_KDA_ONESTEP}},
                                          {ACVP_KDA_TWOSTEP,
                                           &acvp_kda_twostep_kat_handler,
                                           ACVP_ALG_KDA_ALG_STR,
                                           ACVP_ALG_KDA_TWOSTEP,
                                           ACVP_REV_KDA_TWOSTEP,
                                           {ACVP_SUB_KDA_TWOSTEP}},
                                          {ACVP_KDA_HKDF,
                                           &acvp_kda_hkdf_kat_handler,
                                           ACVP_ALG_KDA_ALG_STR,
                                           ACVP_ALG_KDA_HKDF,
                                           ACVP_REV_KDA_HKDF,
                                           {ACVP_SUB_KDA_HKDF}},
                                          {ACVP_KTS_IFC,
                                           &acvp_kts_ifc_kat_handler,
                                           ACVP_ALG_KTS_IFC,
                                           ACVP_ALG_KTS_IFC_COMP,
                                           ACVP_REV_KTS_IFC,
                                           {ACVP_SUB_KTS_IFC}},
                                          {ACVP_SAFE_PRIMES_KEYGEN,
                                           &acvp_safe_primes_kat_handler,
                                           ACVP_ALG_SAFE_PRIMES_STR,
                                           ACVP_ALG_SAFE_PRIMES_KEYGEN,
                                           ACVP_REV_SAFE_PRIMES,
                                           {ACVP_SUB_SAFE_PRIMES_KEYGEN}},
                                          {ACVP_SAFE_PRIMES_KEYVER,
                                           &acvp_safe_primes_kat_handler,
                                           ACVP_ALG_SAFE_PRIMES_STR,
                                           ACVP_ALG_SAFE_PRIMES_KEYVER,
                                           ACVP_REV_SAFE_PRIMES,
                                           {ACVP_SUB_SAFE_PRIMES_KEYVER}},
                                          {ACVP_LMS_KEYGEN,
                                           &acvp_lms_kat_handler,
                                           ACVP_ALG_LMS,
                                           ACVP_ALG_LMS_KEYGEN,
                                           ACVP_REV_LMS,
                                           {ACVP_SUB_LMS_KEYGEN}},
...
ACVP_RESULT acvp_free_test_session(ACVP_CTX *ctx) {
  ...
  if (ctx->path_segment) {
    free(ctx->path_segment);
  }
  if (ctx->api_context) {
    free(ctx->api_context);
  }
  if (ctx->cacerts_file) {
    free(ctx->cacerts_file);
  }
  if (ctx->tls_cert) {
    free(ctx->tls_cert);
  }
  ...
  if (ctx->caps_list) {
    ...
    while (cap_entry) {
      ...
      case ACVP_KDF135_IKEV2_TYPE:
        ...
        acvp_cap_free_domain(
            &cap_entry->cap.kdf135_ikev2_cap->init_nonce_len_domain);
        acvp_cap_free_domain(
            &cap_entry->cap.kdf135_ikev2_cap->respond_nonce_len_domain);
        acvp_cap_free_domain(&cap_entry->cap.kdf135_ikev2_cap->dh_secret_len);
        acvp_cap_free_domain(
            &cap_entry->cap.kdf135_ikev2_cap->key_material_len);
      ...
      case ACVP_SAFE_PRIMES_KEYGEN_TYPE:
        if (cap_entry->cap.safe_primes_keygen_cap->mode->genmeth) {
          acvp_cap_free_pl(
              cap_entry->cap.safe_primes_keygen_cap->mode->genmeth);
        }
      ...
      case ACVP_SAFE_PRIMES_KEYVER_TYPE:
        if (cap_entry->cap.safe_primes_keyver_cap->mode->genmeth) {
          acvp_cap_free_pl(
              cap_entry->cap.safe_primes_keyver_cap->mode->genmeth);
        }
...
ACVP_RESULT acvp_run_vectors_from_file(ACVP_CTX *ctx, const char *req_filename,
  ...
  if (strnlen_s(req_filename, ACVP_JSON_FILENAME_MAX + 1) >
      ACVP_JSON_FILENAME_MAX) {
    ACVP_LOG_ERR("Provided req_filename length > max(%d)",
                 ACVP_JSON_FILENAME_MAX);
    return ACVP_INVALID_ARG;
  }
  ...
  if (json_object_has_value(obj, "isSample")) {
    ...
    ACVP_LOG_WARN(
        "Missing indication of whether tests are sample in file, continuing");
  }
  ...
  while (obj) {
    ...
    ACVP_LOG_STATUS("Writing vector set responses for vector set %d...",
                    ctx->vs_id);
  ...
  ACVP_LOG_STATUS("Completed processing of vector sets. Responses saved in "
                  "specified file.");
end:
  json_value_free(val);
  return rv;
...
ACVP_RESULT acvp_upload_vectors_from_file(ACVP_CTX *ctx,
  ...
  if (strnlen_s(rsp_filename, ACVP_JSON_FILENAME_MAX + 1) >
      ACVP_JSON_FILENAME_MAX) {
    ACVP_LOG_ERR("Provided rsp_filename length > max(%d)",
                 ACVP_JSON_FILENAME_MAX);
    return ACVP_INVALID_ARG;
  }
  ...
  while (vs_entry) {
    ...
    if (rv != ACVP_SUCCESS) {
      ACVP_LOG_ERR(
          "Failed to submit test results for vector set - skipping...");
    }
...
/**
 * Allows application (with proper authentication) to connect to server and get
 * results of previous test session.
 */
...
ACVP_RESULT acvp_get_expected_results(ACVP_CTX *ctx,
  ...
  rv = acvp_parse_session_info_file(ctx, request_filename);
  if (rv != ACVP_SUCCESS) {
    ACVP_LOG_ERR("Failed to parse session info file while trying to get "
                 "expected results");
    goto end;
  }
  if (save_filename && strnlen_s(save_filename, ACVP_JSON_FILENAME_MAX + 1) >
                           ACVP_JSON_FILENAME_MAX) {
...
/**
 * Allows application to continue a previous test session by checking which KAT
 * responses the server is missing
 */
ACVP_RESULT acvp_resume_test_session(ACVP_CTX *ctx,
  ...
  for (i = 0; i < count; i++) {
    ...
    if (ctx->vector_req) {
      // If we are just saving to file, we don't need to check status, download
      // all VS
      rv = acvp_append_vsid_url(ctx, vsid_url);
      if (rv != ACVP_SUCCESS) {
      ...
      if (!diff) {
        ACVP_LOG_ERR(
            "One or more vector sets has expired! Start a new session.");
        rv = ACVP_INVALID_ARG;
        goto end;
      }
  ...
  if (!ctx->vsid_url_list) {
    ACVP_LOG_STATUS(
        "All vector set results already uploaded. Nothing to resume.");
    goto end;
  } else {
    ...
    if (ctx->vector_req) {
      ACVP_LOG_STATUS(
          "Successfully downloaded vector sets and saved to specified file.");
      return ACVP_SUCCESS;
    }
...
/**
 * Allows application (with proper authentication) to connect to server and
 * request it cancel the session, halting processing and deleting related data
 */
...
ACVP_RESULT acvp_set_registration_file(ACVP_CTX *ctx,
  ...
  if (!ctx->vector_req) {
    ACVP_LOG_ERR(
        "The session must be request only to use a manual registraion");
    return ACVP_UNSUPPORTED_OP;
  }
  ...
  if (strnlen_s(json_filename, ACVP_JSON_FILENAME_MAX + 1) >
      ACVP_JSON_FILENAME_MAX) {
    ACVP_LOG_ERR("Provided json_filename length > max(%d)",
                 ACVP_JSON_FILENAME_MAX);
    return ACVP_INVALID_ARG;
  }
...
/*
 * This will return a string form of the current registration, regardless of
 * whether the session has already been started
 */
char *acvp_get_current_registration(ACVP_CTX *ctx, int *len) {
  ...
  /* If we have a registration saved already, use that. Otherwise, build it and
   * return it */
  if (ctx->registration) {
...
ACVP_RESULT acvp_set_server(ACVP_CTX *ctx, const char *server_name, int port) {
  ...
  if (strnlen_s(server_name, ACVP_SESSION_PARAMS_STR_LEN_MAX + 1) >
      ACVP_SESSION_PARAMS_STR_LEN_MAX) {
...
ACVP_RESULT acvp_set_path_segment(ACVP_CTX *ctx, const char *path_segment) {
  ...
  if (strnlen_s(path_segment, ACVP_SESSION_PARAMS_STR_LEN_MAX + 1) >
      ACVP_SESSION_PARAMS_STR_LEN_MAX) {
  ...
  strcpy_s(ctx->path_segment, ACVP_SESSION_PARAMS_STR_LEN_MAX + 1,
           path_segment);
...
ACVP_RESULT acvp_set_api_context(ACVP_CTX *ctx, const char *api_context) {
  ...
  if (strnlen_s(api_context, ACVP_SESSION_PARAMS_STR_LEN_MAX + 1) >
      ACVP_SESSION_PARAMS_STR_LEN_MAX) {
...
ACVP_RESULT acvp_set_cacerts(ACVP_CTX *ctx, const char *ca_file) {
  ...
  if (strnlen_s(ca_file, ACVP_SESSION_PARAMS_STR_LEN_MAX + 1) >
      ACVP_SESSION_PARAMS_STR_LEN_MAX) {
...
ACVP_RESULT acvp_set_certkey(ACVP_CTX *ctx, char *cert_file, char *key_file) {
  ...
  if (strnlen_s(cert_file, ACVP_SESSION_PARAMS_STR_LEN_MAX + 1) >
          ACVP_SESSION_PARAMS_STR_LEN_MAX ||
      strnlen_s(key_file, ACVP_SESSION_PARAMS_STR_LEN_MAX + 1) >
          ACVP_SESSION_PARAMS_STR_LEN_MAX) {
    ACVP_LOG_ERR("CA filename is suspiciously long...");
    return ACVP_INVALID_ARG;
  }
...
ACVP_RESULT acvp_mark_as_request_only(ACVP_CTX *ctx, char *filename) {
  ...
  if (strnlen_s(filename, ACVP_SESSION_PARAMS_STR_LEN_MAX + 1) >
      ACVP_SESSION_PARAMS_STR_LEN_MAX) {
  ...
  ctx->vector_req_file =
      calloc(ACVP_SESSION_PARAMS_STR_LEN_MAX + 1, sizeof(char));
  if (!ctx->vector_req_file) {
    return ACVP_MALLOC_FAIL;
  }
 ...
 */
static ACVP_RESULT acvp_build_login(ACVP_CTX *ctx, char **login, int *login_len,
                                    int refresh) {
  ACVP_RESULT rv = ACVP_SUCCESS;
  ...
  if (ctx->totp_cb) {
    ...
    if (rv != ACVP_SUCCESS) {
      ACVP_LOG_ERR(
          "Error occured in application callback while generating TOTP");
      rv = ACVP_TOTP_FAIL;
      goto err;
    }
...
static ACVP_RESULT acvp_register(ACVP_CTX *ctx) {
  ...
  if (ctx->use_json) {
    ...
    if (count < 1 || count > ACVP_CAP_MAX) {
      ACVP_LOG_ERR("Invalid number of capability objects in provided file! "
                   "Min: 1, Max: %d",
                   ACVP_CAP_MAX);
      rv = ACVP_JSON_ERR;
      goto end;
  ...
  if (rv == ACVP_SUCCESS) {
    ...
    ACVP_LOG_STATUS(
        "Successfully sent registration and received list of vector set URLs");
...
static ACVP_RESULT acvp_parse_validation(ACVP_CTX *ctx) {
  ...
  /* save the request URL to the test session info file, if it is saved in the
   * CTX. */
  if (ctx->session_file_path) {
    ts_val = json_parse_file(ctx->session_file_path);
    if (!ts_val) {
      ACVP_LOG_WARN("Failed to save request URL to test session file. Make "
                    "sure you save it from output!");
      goto end;
    }
    ...
    if (!json_object_get_string(ts_obj, "url")) {
      ACVP_LOG_WARN("Saved testSession file seems invalid. Make sure you save "
                    "request URL from output!");
      goto end;
    }
...
ACVP_RESULT acvp_notify_large(ACVP_CTX *ctx, const char *url, char *large_url,
  ...
  ACVP_RESULT rv = ACVP_SUCCESS;
  JSON_Value *arr_val = NULL, *val = NULL, *ver_val = NULL, *server_val = NULL;
  ...
  if (!large_url)
    return ACVP_MISSING_ARG;
  if (!(data_len > ctx->post_size_constraint))
    return ACVP_INVALID_ARG;
  ...
  *substr = '\0';
  ...
  ACVP_LOG_ERR("Notifying /large endpoint for this submission... %s",
               large_notify);
...
err:
  ...
  if (server_val)
    json_value_free(server_val);
  if (large_notify)
    json_free_serialized_string(large_notify);
  return rv;
}
#endif
...
static ACVP_RESULT acvp_parse_session_info_file(ACVP_CTX *ctx,
  ...
  if (strnlen_s(filename, ACVP_JSON_FILENAME_MAX + 1) >
      ACVP_JSON_FILENAME_MAX) {
    ACVP_LOG_ERR("Provided filename length > max(%d)", ACVP_JSON_FILENAME_MAX);
    return ACVP_INVALID_ARG;
  }
 ...
 * function will ensure that retry periods will sum to no longer than
 * ACVP_MAX_WAIT_TIME.
 */
static ACVP_RESULT acvp_retry_handler(ACVP_CTX *ctx, int *retry_period,
                                      unsigned int *waited_so_far, int modifier,
                                      ACVP_WAITING_STATUS situation) {
  /* perform check at beginning of function call, so library can check one more
   * time when max time is reached to see if server status has changed */
  ...
  if (*retry_period <= ACVP_RETRY_TIME_MIN ||
  ...
  if (situation == ACVP_WAITING_FOR_TESTS) {
    ACVP_LOG_STATUS("200 OK KAT values not ready, server requests we wait %u "
                    "seconds and try again...",
                    *retry_period);
  } else if (situation == ACVP_WAITING_FOR_RESULTS) {
    ACVP_LOG_STATUS(
        "200 OK results not ready, waiting %u seconds and trying again...",
        *retry_period);
  } else {
    ACVP_LOG_STATUS("200 OK, waiting %u seconds and trying again...",
                    *retry_period);
  }

  acvp_sleep(*retry_period);

  /* ensure that all parameters are valid and that we do not wait longer than
   * ACVP_MAX_WAIT_TIME */
...
static ACVP_RESULT acvp_process_vsid(ACVP_CTX *ctx, char *vsid_url, int count) {
  ...
  while (retry) {
    ...
    if (retry_period) {
       ...
       */
      if (acvp_retry_handler(ctx, &retry_period, &time_waited_so_far, 1,
                             ACVP_WAITING_FOR_TESTS) !=
          ACVP_KAT_DOWNLOAD_RETRY) {
        ACVP_LOG_STATUS(
            "Maximum wait time with server reached! (Max: %d seconds)",
            ACVP_MAX_WAIT_TIME);
        rv = ACVP_TRANSPORT_FAIL;
        goto end;
      };
      ...
      if (ctx->vector_req) {
        ...
        if (count == 0) {
          ...
          json_object_set_value(ts_obj, "vectorSetUrls",
          ...
          rv = acvp_json_serialize_to_file_pretty_w(ts_val,
                                                    ctx->vector_req_file);
          if (rv != ACVP_SUCCESS) {
            ACVP_LOG_ERR("File write error");
            json_value_free(ts_val);
...
static ACVP_RESULT acvp_dispatch_vector_set(ACVP_CTX *ctx, JSON_Object *obj) {
  ...
  for (i = 0; i < ACVP_ALG_MAX; i++) {
    strcmp_s(alg_tbl[i].name, ACVP_ALG_NAME_MAX, alg, &diff);
    if (!diff) {
      if (mode == NULL ||
          alg_tbl[i].cipher == ACVP_KDF108) { // KDF108-KMAC has a mode!
        rv = (alg_tbl[i].handler)(ctx, obj);
        return rv;
      }

      if (alg_tbl[i].mode != NULL) {
        strcmp_s(alg_tbl[i].mode, ACVP_ALG_MODE_MAX, mode, &diff);
        if (!diff) {
          rv = (alg_tbl[i].handler)(ctx, obj);
          return rv;
        }
...
/*
 * This function will get the test results for a test session by checking the
...
static ACVP_RESULT acvp_get_result_test_session(ACVP_CTX *ctx,
  ...
  while (1) {
    ...
    for (i = 0; i < count; i++) {
      ...
      strcmp_s("expired", 7, status, &diff);
      if (!diff) {
        ACVP_LOG_ERR("One or more vector sets expired before results were "
                     "submitted. Please start a new test session.");
        goto end;
      }

      strcmp_s("unreceived", 10, status, &diff);
      if (!diff) {
        ACVP_LOG_ERR("Missing submissions for one or more vector sets. Please "
                     "submit responses for all vector sets.");
        goto end;
      }
      /*
      ...
      /*
       * If the result is fail, retrieve vector set, get algorithm name, add to
       * list
       */
      ...
      if (!diff) {
        ...
        if (!vsurl) {
          ACVP_LOG_ERR(
              "No vector set URL when generating failed algorithm list");
          break;
        }
        if (!acvp_lookup_str_list(&failedVsList, vsurl)) {
          // append the vsurl to the list so we dont download/check same one
          // twice
          rv = acvp_append_str_list(&failedVsList, vsurl);
          if (rv != ACVP_SUCCESS) {
            ACVP_LOG_ERR(
                "Error appending failed algorithm name to list, skipping...");
            continue;
          }
          // retrieve_vector_set expects a non-const string
          char *vs_url = calloc(ACVP_REQUEST_STR_LEN_MAX + 1, sizeof(char));
          if (!vs_url) {
            ACVP_LOG_ERR("Unable to calloc when reporting failed algorithms, "
                         "skipping...");
            continue;
          }
          strncpy_s(vs_url, ACVP_REQUEST_STR_LEN_MAX + 1, vsurl,
                    ACVP_REQUEST_STR_LEN_MAX);
          rv = acvp_retrieve_vector_set(ctx, vs_url);
          free(vs_url);
          if (rv != ACVP_SUCCESS) {
            ACVP_LOG_ERR("Unable to retrieve vector set while reporting failed "
                         "algorithms, skipping...");
            continue;
          }
          ...
          if (!val2) {
            ACVP_LOG_ERR("JSON parse error while reporting failed algorithms, "
                         "skipping...");
            continue;
          }
          ...
          if (!acvp_lookup_str_list(&failedAlgList, alg) ||
            ...
            if (mode) {
              ...
              // use empty node to keep mode and algorithm indexes aligned in
              // lists
              rv = acvp_append_str_list(&failedModeList, "");
            }
            if (rv != ACVP_SUCCESS) {
              ACVP_LOG_ERR(
                  "Error appending failed mode name to list, skipping...");
              continue;
            }
            if (val2)
              json_value_free(val2);
    ...
    if (testsCompleted >= count) {
      ...
      if (passed == 1) {
         ...
         */
        ACVP_LOG_STATUS(
            "Test session complete: some vectors failed, reporting results...");
        ACVP_LOG_STATUS(
            "Note: Use verbose-level logging to see results of each test case");
      ...
      if (acvp_retry_handler(ctx, &retry_interval, &time_waited_so_far, 1,
...
static ACVP_RESULT acvp_validate_test_session(ACVP_CTX *ctx) {
  ...
  if (ctx->session_passed != 1) {
    ACVP_LOG_ERR("This testSession cannot be certified. Required disposition "
                 "== 'pass'.");
...
static ACVP_RESULT acvp_post_data(ACVP_CTX *ctx, char *filename) {
  ACVP_RESULT rv = ACVP_SUCCESS;
  JSON_Value *reg_arry_val = NULL;
...
/**
 * Creates a file with the test session info, which can be used to access the
 * test session in the future.
 *
...
static ACVP_RESULT acvp_write_session_info(ACVP_CTX *ctx) {
  ...
  ptr = ctx->session_url;
  while (*ptr != 0) {
    memcmp_s(ptr, strlen(TEST_SESSION), TEST_SESSION, strlen(TEST_SESSION),
             &diff);
    if (!diff) {
      break;
    }
  ...
  /*
   * Check the total length of our path, prefix, and total concatenated
   * filename. Add 6 to checks for .json and the _ beteween prefix and session
   * ID If any lengths are too long, just use default prefix and location
   */
  if (path) {
  ...
  if (pathLen > ACVP_JSON_FILENAME_MAX - 6) {
    ACVP_LOG_WARN("Provided ACV_SESSION_SAVE information too long (current max "
                  "path len: %d). Using defaults",
                  ACVP_JSON_FILENAME_MAX);
    path = NULL;
    prefix = NULL;
  }
  ...
  // if we have a path, use it, otherwise use default (usually directory of
  // parent application)
  if (path) {
    diff = snprintf(filename, ACVP_JSON_FILENAME_MAX, "%s/%s_%s.json", path,
                    prefix, ptr);
  } else {
    diff =
        snprintf(filename, ACVP_JSON_FILENAME_MAX, "%s_%s.json", prefix, ptr);
  }
  if (diff < 0) {
    rv = ACVP_UNSUPPORTED_OP;
    goto end;
  ...
  if (rv != ACVP_SUCCESS) {
    ACVP_LOG_ERR(
        "File write error. Check that directory exists and allows writes.");
    goto end;
  }
  ...
  if (strncpy_s(ctx->session_file_path, ACVP_JSON_FILENAME_MAX + 1, filename,
                ACVP_JSON_FILENAME_MAX)) {
    ACVP_LOG_ERR(
        "Buffer write error while trying to save session file path to CTX");
    rv = ACVP_UNSUPPORTED_OP;
    goto end;
  }
  ...
  if (allocedPrefix && prefix)
    free(prefix);
  if (ts_obj)
    json_object_soft_remove(ts_obj, "registration");
  if (ts_val)
    json_value_free(ts_val);
  free(filename);
  return rv;
...
ACVP_RESULT acvp_run(ACVP_CTX *ctx, int fips_validation) {
  ...
  if (fips_validation) {
    ...
    if (ACVP_SUCCESS != rv) {
      ACVP_LOG_ERR(
          "Issue(s) with validation metadata, not continuing with session.");
      return ACVP_UNSUPPORTED_OP;
    }
  ...
  // write session info so if we time out or lose connection waiting for
  // results, we can recheck later on
  if (!ctx->put) {
    if (acvp_write_session_info(ctx) != ACVP_SUCCESS) {
      ACVP_LOG_ERR(
          "Error writing the session info file. Continuing, but session will "
          "not be able to be resumed or checked later on");
    }
  }
...
const char *acvp_version(void) { return ACVP_LIBRARY_VERSION; }

const char *acvp_protocol_version(void) { return ACVP_VERSION; }
...
ACVP_RESULT acvp_put_data_from_file(ACVP_CTX *ctx, const char *put_filename) {
  ...
  if (strnlen_s(put_filename, ACVP_JSON_FILENAME_MAX + 1) >
      ACVP_JSON_FILENAME_MAX) {
    ACVP_LOG_ERR("Provided put_filename length > max(%d)",
                 ACVP_JSON_FILENAME_MAX);
    return ACVP_INVALID_ARG;
  }
  ...
  if (jwt &&
      (json_object_has_value(obj, "oe") ||
       json_object_has_value(obj, "oeUrl")) &&
      (json_object_has_value(obj, "module") ||
       json_object_has_value(obj, "moduleUrl"))) {
    validation = 1;
  }
...
static ACVP_RESULT acvp_put_data_from_ctx(ACVP_CTX *ctx) {
  ...
  if (strnlen_s(ctx->put_filename, ACVP_JSON_FILENAME_MAX + 1) >
      ACVP_JSON_FILENAME_MAX) {
    ACVP_LOG_ERR("Provided put_filename length > max(%d)",
                 ACVP_JSON_FILENAME_MAX);
    return ACVP_INVALID_ARG;
