...
Test(EnableCapKDF108, good, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf108_set_domain(ctx, ACVP_KDF108_MODE_COUNTER,
                                  ACVP_KDF108_SUPPORTED_LEN, 8, 384, 8);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf108_set_domain(ctx, ACVP_KDF108_MODE_FEEDBACK,
                                  ACVP_KDF108_SUPPORTED_LEN, 8, 384, 8);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf108_set_domain(ctx, ACVP_KDF108_MODE_DPI,
                                  ACVP_KDF108_SUPPORTED_LEN, 8, 384, 8);
  cr_assert(rv == ACVP_SUCCESS);
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf108_set_parm(ctx, ACVP_KDF108_MODE_COUNTER,
                                ACVP_KDF108_SUPPORTS_EMPTY_IV, 0);
  cr_assert(rv == ACVP_SUCCESS);
}
...
Test(EnableCapKDF108, alg_mismatch, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf108_set_parm(ctx, 999, ACVP_KDF108_MAC_MODE,
                                ACVP_KDF108_MAC_MODE_HMAC_SHA1);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapKDF108, invalid_domain, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf108_set_domain(ctx, ACVP_KDF108_MODE_COUNTER,
                                  ACVP_KDF108_SUPPORTED_LEN, 0, 384, 8);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf108_set_domain(ctx, ACVP_KDF108_MODE_COUNTER,
                                  ACVP_KDF108_SUPPORTED_LEN, 8, 99999, 8);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapKDF108, invalid_params, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf108_set_parm(ctx, ACVP_KDF108_MODE_COUNTER,
                                ACVP_KDF108_MAC_MODE, 0);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf108_set_parm(ctx, ACVP_KDF108_MODE_COUNTER,
                                ACVP_KDF108_MAC_MODE, 999);
  cr_assert(rv == ACVP_INVALID_ARG);

  rv = acvp_cap_kdf108_set_parm(ctx, ACVP_KDF108_MODE_COUNTER,
                                ACVP_KDF108_COUNTER_LEN, 7);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf108_set_parm(ctx, ACVP_KDF108_MODE_COUNTER,
                                ACVP_KDF108_COUNTER_LEN, 999);
  cr_assert(rv == ACVP_INVALID_ARG);

  rv = acvp_cap_kdf108_set_parm(ctx, ACVP_KDF108_MODE_COUNTER,
                                ACVP_KDF108_FIXED_DATA_ORDER, 0);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf108_set_parm(ctx, ACVP_KDF108_MODE_COUNTER,
                                ACVP_KDF108_SUPPORTS_EMPTY_IV, 3);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf108_set_parm(ctx, ACVP_KDF108_MODE_COUNTER,
                                ACVP_KDF108_SUPPORTS_EMPTY_IV, 3);
  cr_assert(rv == ACVP_INVALID_ARG);
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf108_set_parm(ctx, ACVP_KDF108_MODE_COUNTER,
                                ACVP_KDF108_SUPPORTS_EMPTY_IV, 2);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapKDFSNMP, properly, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_snmp_set_parm(ctx, ACVP_KDF135_SNMP,
                                     ACVP_KDF135_SNMP_PASS_LEN, 128);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_snmp_set_parm(ctx, ACVP_KDF135_SNMP,
                                     ACVP_KDF135_SNMP_PASS_LEN, 64);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_snmp_set_engid(ctx, ACVP_KDF135_SNMP,
                                      "0a0a0a0a0a0a0a0a0a");
  cr_assert(rv == ACVP_SUCCESS);
}
...
Test(EnableCapKDFSNMP, invalid_params, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_snmp_set_parm(ctx, ACVP_KDF135_SNMP,
                                     ACVP_KDF135_SNMP_PASS_LEN, 0);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf135_snmp_set_parm(ctx, ACVP_KDF135_SNMP,
                                     ACVP_KDF135_SNMP_PASS_LEN, 99999);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf135_snmp_set_engid(
      ctx, ACVP_KDF135_SNMP,
...
Test(EnableCapKDFSRTP, good, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_srtp_set_parm(ctx, ACVP_KDF135_SRTP,
                                     ACVP_SRTP_SUPPORT_ZERO_KDR, 0);
  cr_assert(rv == ACVP_SUCCESS);
  for (i = 0; i < 24; i++) {
    rv = acvp_cap_kdf135_srtp_set_parm(ctx, ACVP_KDF135_SRTP,
                                       ACVP_SRTP_KDF_EXPONENT, i + 1);
    cr_assert(rv == ACVP_SUCCESS);
  }
  rv = acvp_cap_kdf135_srtp_set_parm(ctx, ACVP_KDF135_SRTP,
                                     ACVP_SRTP_AES_KEYLEN, 128);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_srtp_set_parm(ctx, ACVP_KDF135_SRTP,
                                     ACVP_SRTP_AES_KEYLEN, 192);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_srtp_set_parm(ctx, ACVP_KDF135_SRTP,
                                     ACVP_SRTP_AES_KEYLEN, 256);
  cr_assert(rv == ACVP_SUCCESS);
}
...
Test(EnableCapKDFSRTP, invalid_params, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_srtp_set_parm(ctx, ACVP_KDF135_SRTP,
                                     ACVP_SRTP_SUPPORT_ZERO_KDR, 3);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf135_srtp_set_parm(ctx, ACVP_KDF135_SRTP,
                                     ACVP_SRTP_KDF_EXPONENT, -1);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf135_srtp_set_parm(ctx, ACVP_KDF135_SRTP,
                                     ACVP_SRTP_KDF_EXPONENT, 25);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf135_srtp_set_parm(ctx, ACVP_KDF135_SRTP,
                                     ACVP_SRTP_AES_KEYLEN, 512);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapKDFSSH, properly, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv =
      acvp_cap_kdf135_ssh_set_parm(ctx, ACVP_KDF135_SSH, ACVP_SSH_METH_TDES_CBC,
...
Test(EnableCapKDFSSH, param_alg_mismatch, .fini = teardown) {
  ...
  rv = acvp_cap_kdf135_ssh_enable(ctx, &dummy_handler_success);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_ssh_set_parm(ctx, ACVP_KDF135_SNMP,
                                    ACVP_SSH_METH_TDES_CBC,
                                    ACVP_SHA256 | ACVP_SHA384 | ACVP_SHA512);
  cr_assert(rv == ACVP_NO_CAP);
  rv = acvp_cap_kdf135_ssh_set_parm(ctx, ACVP_KDF135_SRTP,
                                    ACVP_SSH_METH_TDES_CBC,
                                    ACVP_SHA256 | ACVP_SHA384 | ACVP_SHA512);
  cr_assert(rv == ACVP_NO_CAP);
}
...
Test(EnableCapCMAC, properly, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_cmac_set_domain(ctx, ACVP_CMAC_AES, ACVP_CMAC_MSGLEN, 0, 65536,
                                8);
  cr_assert(rv == ACVP_SUCCESS);
...
Test(EnableCapCMAC, invalid_args, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_cmac_set_domain(ctx, ACVP_CMAC_AES, ACVP_CMAC_MSGLEN, -1, 65536,
                                8);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_cmac_set_domain(ctx, ACVP_CMAC_AES, ACVP_CMAC_MSGLEN, 0,
                                9999999, 8);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_cmac_set_domain(ctx, ACVP_CMAC_AES, ACVP_CMAC_MSGLEN, 0, 65536,
                                7);
...
Test(EnableCapHMAC, properly, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_hmac_set_domain(ctx, ACVP_HMAC_SHA2_224, ACVP_HMAC_KEYLEN, 256,
                                448, 8);
  cr_assert(rv == ACVP_SUCCESS);
...
Test(EnableCapHMAC, param_alg_mismatch, .fini = teardown) {
  ...
  rv =
      acvp_cap_hmac_set_parm(ctx, ACVP_HMAC_SHA2_224, ACVP_HMAC_KEYLEN, 32 * 8);
  cr_assert(rv == ACVP_NO_CAP);
}
...
Test(EnableCapHMAC, invalid_args, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_INVALID_ARG);
  /*
   * TODO: need to make sure the library checks if the max is greater than the
   * min [edaw] the domain here needs refactoring
   */
  rv =
      acvp_cap_hmac_set_parm(ctx, ACVP_HMAC_SHA2_512, ACVP_HMAC_KEYLEN, 524889);
  cr_assert(rv == ACVP_INVALID_ARG);

  rv = acvp_cap_hmac_set_domain(ctx, ACVP_HMAC_SHA2_512, ACVP_HMAC_KEYLEN, 7,
                                256, 8);
  cr_assert(rv == ACVP_INVALID_ARG);
  ...
  rv = acvp_cap_hmac_set_domain(ctx, ACVP_HMAC_SHA2_512, ACVP_HMAC_MACLEN, 31,
                                512, 8);
  cr_assert(rv == ACVP_INVALID_ARG);
...
Test(EnableCapRSAkeyGen, proper_modes_params, .fini = teardown) {
  ...
  rv = acvp_cap_rsa_keygen_set_mode(ctx, ACVP_RSA_KEYGEN_B35);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_rsa_keygen_set_primes(ctx, ACVP_RSA_KEYGEN_B35, 2048,
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_rsa_keygen_set_primes(ctx, ACVP_RSA_KEYGEN_B35, 3072,
                                      ACVP_RSA_PRIME_HASH_ALG, ACVP_SHA256);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_rsa_keygen_set_primes(ctx, ACVP_RSA_KEYGEN_B35, 3072,
                                      ACVP_RSA_PRIME_TEST,
...
Test(EnableCapRSAkeyGen, invalid_modes_params, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_rsa_keygen_set_primes(ctx, ACVP_RSA_KEYGEN_B35, 2048,
                                      ACVP_RSA_PRIME_HASH_ALG, 257);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_rsa_keygen_set_primes(ctx, ACVP_RSA_KEYGEN_B35, 2048,
                                      ACVP_RSA_PRIME_TEST, 256);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapAES, properly, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv =
      acvp_cap_sym_cipher_set_parm(ctx, ACVP_AES_GCM, ACVP_SYM_CIPH_PTLEN, 128);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_sym_cipher_set_parm(ctx, ACVP_AES_GCM, ACVP_SYM_CIPH_AADLEN,
                                    128);
  cr_assert(rv == ACVP_SUCCESS);
}
...
Test(EnableCapAES, alg_mismatch, .fini = teardown) {
  setup_empty_ctx(&ctx);
  rv = acvp_cap_sym_cipher_enable(ctx, ACVP_ECDSA_KEYGEN,
                                  &dummy_handler_success);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_set_prereq(ctx, ACVP_AES_GCM, ACVP_PREREQ_AES, cvalue);
  cr_assert(rv == ACVP_NO_CAP);
}
...
Test(EnableCapAES, invalid_keylens, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_INVALID_ARG);
  rv =
      acvp_cap_sym_cipher_set_parm(ctx, ACVP_AES_CFB1, ACVP_SYM_CIPH_KEYLEN, 0);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapAES, invalid_param_lens, .fini = teardown) {
  ...
  rv = acvp_cap_sym_cipher_enable(ctx, ACVP_AES_CFB1, &dummy_handler_success);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_sym_cipher_set_parm(ctx, ACVP_AES_CFB1, ACVP_SYM_CIPH_PTLEN,
                                    333333);
  cr_assert(rv == ACVP_INVALID_ARG);
  ...
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_sym_cipher_set_parm(ctx, ACVP_AES_CCM, ACVP_SYM_CIPH_IVLEN,
                                    333333);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_sym_cipher_set_parm(ctx, ACVP_AES_CCM, ACVP_SYM_CIPH_IVLEN, 0);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_sym_cipher_set_parm(ctx, ACVP_AES_CCM, ACVP_SYM_CIPH_AADLEN,
                                    333333);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_sym_cipher_set_parm(ctx, ACVP_AES_CCM, ACVP_SYM_CIPH_AADLEN,
                                    -333);
...
Test(EnableCapAES, cipher_invalid_parm_domain, .fini = teardown) {
  setup_empty_ctx(&ctx);
  rv =
      acvp_cap_sym_cipher_enable(ctx, ACVP_AES_CBC_CS2, &dummy_handler_success);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_sym_cipher_set_domain(ctx, ACVP_AES_CBC_CS2,
                                      ACVP_SYM_CIPH_KEYLEN, 0, 128, 8);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapAES, cipher_domain_no_ctx, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_sym_cipher_set_domain(NULL, ACVP_AES_XPN,
                                      ACVP_SYM_CIPH_DOMAIN_PTLEN, 0, 128, 8);
  cr_assert(rv == ACVP_NO_CTX);
}
...
Test(EnableCapAES, cipher_domain_bad_values, .fini = teardown) {
  setup_empty_ctx(&ctx);
  rv =
      acvp_cap_sym_cipher_enable(ctx, ACVP_AES_CBC_CS3, &dummy_handler_success);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_sym_cipher_set_domain(ctx, ACVP_AES_CBC_CS3,
                                      ACVP_SYM_CIPH_DOMAIN_PTLEN, -64, 128, 8);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_sym_cipher_set_domain(ctx, ACVP_AES_CBC_CS3,
                                      ACVP_SYM_CIPH_DOMAIN_PTLEN, 128, 64, 8);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_sym_cipher_set_domain(ctx, ACVP_AES_CBC_CS3,
                                      ACVP_SYM_CIPH_DOMAIN_PTLEN, 0, 128, 0);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_sym_cipher_set_domain(ctx, ACVP_AES_CBC_CS3,
                                      ACVP_SYM_CIPH_KEYLEN, 0, 0, 8);
  cr_assert(rv == ACVP_INVALID_ARG);
}

/*
 * Enable an AES cipher, register a payloadLen, then register a payloadLen
 * domain
 */
Test(EnableCapAES, dup_payload_registration, .fini = teardown) {
  setup_empty_ctx(&ctx);
  rv =
      acvp_cap_sym_cipher_enable(ctx, ACVP_AES_CBC_CS1, &dummy_handler_success);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_sym_cipher_set_parm(ctx, ACVP_AES_CBC_CS1, ACVP_SYM_CIPH_PTLEN,
                                    33333);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_sym_cipher_set_domain(ctx, ACVP_AES_CBC_CS1,
                                      ACVP_SYM_CIPH_DOMAIN_PTLEN, 0, 1024, 8);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapTDES, alg_param_mismatch, .fini = teardown) {
  ...
  rv = acvp_cap_sym_cipher_enable(ctx, ACVP_TDES_CBC, &dummy_handler_success);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_sym_cipher_set_parm(ctx, ACVP_TDES_CBC, ACVP_SYM_CIPH_TAGLEN,
                                    256);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_sym_cipher_set_parm(ctx, ACVP_TDES_CBC, ACVP_SYM_CIPH_AADLEN,
                                    64);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapKDF135IKEv1, good, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_ikev1_set_domain(ctx, ACVP_KDF_IKEv1_INIT_NONCE_LEN, 64,
                                        2048, 1);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_ikev1_set_domain(ctx, ACVP_KDF_IKEv1_RESPOND_NONCE_LEN,
                                        64, 2048, 1);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_ikev1_set_domain(ctx, ACVP_KDF_IKEv1_DH_SECRET_LEN, 224,
                                        8192, 1);
  cr_assert(rv == ACVP_SUCCESS);
  rv =
      acvp_cap_kdf135_ikev1_set_domain(ctx, ACVP_KDF_IKEv1_PSK_LEN, 8, 8192, 1);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_ikev1_set_parm(ctx, ACVP_KDF_IKEv1_HASH_ALG, ACVP_SHA1);
  cr_assert(rv == ACVP_SUCCESS);
  rv =
      acvp_cap_kdf135_ikev1_set_parm(ctx, ACVP_KDF_IKEv1_HASH_ALG, ACVP_SHA384);
  cr_assert(rv == ACVP_SUCCESS);
  rv =
      acvp_cap_kdf135_ikev1_set_parm(ctx, ACVP_KDF_IKEv1_HASH_ALG, ACVP_SHA224);
  cr_assert(rv == ACVP_SUCCESS);
  rv =
      acvp_cap_kdf135_ikev1_set_parm(ctx, ACVP_KDF_IKEv1_HASH_ALG, ACVP_SHA256);
  cr_assert(rv == ACVP_SUCCESS);
  rv =
      acvp_cap_kdf135_ikev1_set_parm(ctx, ACVP_KDF_IKEv1_HASH_ALG, ACVP_SHA512);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_ikev1_set_parm(ctx, ACVP_KDF_IKEv1_AUTH_METHOD,
                                      ACVP_KDF135_IKEV1_AMETH_PSK);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_ikev1_set_parm(ctx, ACVP_KDF_IKEv1_AUTH_METHOD,
                                      ACVP_KDF135_IKEV1_AMETH_DSA);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_ikev1_set_parm(ctx, ACVP_KDF_IKEv1_AUTH_METHOD,
...
Test(EnableCapKDF135IKEv1, invalid_domain, .fini = teardown) {
  ...
  rv = acvp_cap_kdf135_ikev1_enable(ctx, &dummy_handler_success);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_ikev1_set_domain(ctx, ACVP_KDF_IKEv1_INIT_NONCE_LEN, 0,
                                        2048, 1);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf135_ikev1_set_domain(ctx, ACVP_KDF_IKEv1_INIT_NONCE_LEN, 64,
                                        9999, 1);
  ...
  rv = acvp_cap_kdf135_ikev1_set_domain(ctx, ACVP_KDF_IKEv1_RESPOND_NONCE_LEN,
                                        64, 9999, 1);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf135_ikev1_set_domain(ctx, ACVP_KDF_IKEv1_DH_SECRET_LEN, 0,
                                        8192, 1);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf135_ikev1_set_domain(ctx, ACVP_KDF_IKEv1_DH_SECRET_LEN, 224,
                                        99999, 1);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv =
      acvp_cap_kdf135_ikev1_set_domain(ctx, ACVP_KDF_IKEv1_PSK_LEN, 0, 8192, 1);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf135_ikev1_set_domain(ctx, ACVP_KDF_IKEv1_PSK_LEN, 8, 99999,
                                        1);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapKDF135IKEv2, good_domain, .fini = teardown) {
  ...
  rv = acvp_cap_kdf135_ikev2_enable(ctx, &dummy_handler_success);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_ikev2_set_domain(ctx, ACVP_RESPOND_NONCE_LEN, 64, 2048,
                                        1);
  cr_assert(rv == ACVP_SUCCESS);
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kdf135_ikev2_set_domain(ctx, ACVP_KEY_MATERIAL_LEN, 160, 2048,
                                        1);
  cr_assert(rv == ACVP_SUCCESS);
}
...
Test(EnableCapKDF135IKEv2, invalid_len_params, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf135_ikev2_set_domain(ctx, ACVP_RESPOND_NONCE_LEN, 64, 9999,
                                        8);
  cr_assert(rv == ACVP_INVALID_ARG);
  ...
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kdf135_ikev2_set_domain(ctx, ACVP_KEY_MATERIAL_LEN, 224, 99999,
                                        8);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapECDSA, mode_mismatch_kg, .fini = teardown) {
  ...
  rv = acvp_cap_ecdsa_enable(ctx, ACVP_ECDSA_KEYGEN, &dummy_handler_success);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_ecdsa_set_parm(ctx, ACVP_KDF135_SNMP, ACVP_ECDSA_CURVE,
                               ACVP_EC_CURVE_B233);
  cr_assert(rv == ACVP_NO_CAP);
}
...
Test(EnableCapECDSA, good_siggen, .fini = teardown) {
  ...
  // rv = acvp_cap_ecdsa_set_parm(ctx, ACVP_ECDSA_SIGGEN, ACVP_ECDSA_HASH_ALG,
  // ACVP_SHA384);
  rv = acvp_cap_ecdsa_set_curve_hash_alg(ctx, ACVP_ECDSA_SIGGEN,
                                         ACVP_EC_CURVE_B409, ACVP_SHA384);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_ecdsa_set_parm(ctx, ACVP_ECDSA_SIGGEN, ACVP_ECDSA_HASH_ALG,
                               ACVP_SHA512);
  cr_assert(rv == ACVP_SUCCESS);
...
Test(EnableCapECDSA, invalid_args_sg, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_INVALID_ARG);
  rv =
      acvp_cap_ecdsa_set_parm(ctx, ACVP_ECDSA_SIGGEN, ACVP_ECDSA_HASH_ALG, 257);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_ecdsa_set_curve_hash_alg(ctx, ACVP_ECDSA_SIGGEN,
                                         ACVP_EC_CURVE_K233, ACVP_SHA224);
  cr_assert(rv == ACVP_UNSUPPORTED_OP);
  rv = acvp_cap_ecdsa_set_parm(ctx, ACVP_ECDSA_SIGGEN, ACVP_ECDSA_CURVE,
                               ACVP_EC_CURVE_P192);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_ecdsa_set_curve_hash_alg(ctx, ACVP_ECDSA_SIGGEN,
                                         ACVP_EC_CURVE_P192, 3);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapECDSA, good_sigver, .fini = teardown) {
  ...
  // rv = acvp_cap_ecdsa_set_parm(ctx, ACVP_ECDSA_SIGVER, ACVP_ECDSA_HASH_ALG,
  // ACVP_SHA384);
  rv = acvp_cap_ecdsa_set_curve_hash_alg(ctx, ACVP_ECDSA_SIGVER,
                                         ACVP_EC_CURVE_B409, ACVP_SHA384);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_ecdsa_set_parm(ctx, ACVP_ECDSA_SIGVER, ACVP_ECDSA_HASH_ALG,
                               ACVP_SHA512);
...
Test(EnableCapECDSA, invalid_args_sv, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_INVALID_ARG);
  rv =
      acvp_cap_ecdsa_set_parm(ctx, ACVP_ECDSA_SIGVER, ACVP_ECDSA_HASH_ALG, 257);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_ecdsa_set_curve_hash_alg(ctx, ACVP_ECDSA_SIGVER,
                                         ACVP_EC_CURVE_K233, ACVP_SHA224);
  cr_assert(rv == ACVP_UNSUPPORTED_OP);
...
Test(EnableCapDRBG, good_hash, .fini = teardown) {
  ...
  rv = acvp_cap_drbg_set_length(ctx, ACVP_HASHDRBG, ACVP_DRBG_SHA_1, 0,
                                ACVP_DRBG_ENTROPY_LEN, (int)128, (int)64,
                                (int)256);
  cr_assert(rv == ACVP_SUCCESS);
  rv =
      acvp_cap_drbg_set_length(ctx, ACVP_HASHDRBG, ACVP_DRBG_SHA_1, 0,
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_drbg_set_length(ctx, ACVP_HASHDRBG, ACVP_DRBG_SHA_1, 0,
                                ACVP_DRBG_ADD_IN_LEN, (int)0, (int)128,
                                (int)256);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_drbg_set_parm(ctx, ACVP_HASHDRBG, ACVP_DRBG_SHA_1, 0,
...
Test(EnableCapDRBG, good_hmac, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_set_prereq(ctx, ACVP_HMACDRBG, ACVP_PREREQ_SHA, cvalue);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_set_prereq(ctx, ACVP_HMACDRBG, ACVP_PREREQ_HMAC, cvalue);
  cr_assert(rv == ACVP_SUCCESS);
  ...
  rv = acvp_cap_drbg_set_length(ctx, ACVP_HMACDRBG, ACVP_DRBG_SHA_224, 0,
                                ACVP_DRBG_ENTROPY_LEN, (int)192, (int)64,
                                (int)256);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_drbg_set_length(ctx, ACVP_HMACDRBG, ACVP_DRBG_SHA_224, 0,
                                ACVP_DRBG_NONCE_LEN, (int)192, (int)64,
                                (int)256);
  cr_assert(rv == ACVP_SUCCESS);
  rv =
      acvp_cap_drbg_set_length(ctx, ACVP_HMACDRBG, ACVP_DRBG_SHA_224, 0,
                               ACVP_DRBG_PERSO_LEN, (int)0, (int)128, (int)256);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_drbg_set_length(ctx, ACVP_HMACDRBG, ACVP_DRBG_SHA_224, 0,
                                ACVP_DRBG_ADD_IN_LEN, (int)0, (int)128,
...
Test(EnableCapDRBG, good_ctr, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_set_prereq(ctx, ACVP_CTRDRBG, ACVP_PREREQ_AES, cvalue);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_set_prereq(ctx, ACVP_CTRDRBG, ACVP_PREREQ_TDES, cvalue);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_set_prereq(ctx, ACVP_CTRDRBG, ACVP_PREREQ_AES, cvalue);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_drbg_set_length(ctx, ACVP_CTRDRBG, ACVP_DRBG_AES_128, 0,
                                ACVP_DRBG_ENTROPY_LEN, (int)128, (int)128,
                                (int)256);
  cr_assert(rv == ACVP_SUCCESS);
  rv =
      acvp_cap_drbg_set_length(ctx, ACVP_CTRDRBG, ACVP_DRBG_AES_128, 0,
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_drbg_set_length(ctx, ACVP_CTRDRBG, ACVP_DRBG_AES_128, 0,
                                ACVP_DRBG_ADD_IN_LEN, (int)0, (int)256,
                                (int)256);
  cr_assert(rv == ACVP_SUCCESS);
...
Test(EnableCapKASECC, invalid_params, .fini = teardown) {
  ...
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kas_ecc_set_parm(ctx, ACVP_KAS_ECC_CDH, ACVP_KAS_ECC_MODE_CDH,
                                 ACVP_KAS_ECC_FUNCTION, 0);
  cr_assert(rv == ACVP_INVALID_ARG);
  // invalid cipher
  rv = acvp_cap_kas_ecc_set_parm(ctx, ACVP_AES_CBC, ACVP_KAS_ECC_MODE_CDH,
                                 ACVP_KAS_ECC_CURVE, ACVP_EC_CURVE_P224);
  cr_assert(rv == ACVP_INVALID_ARG);
  // invalid mode
  rv = acvp_cap_kas_ecc_set_parm(ctx, ACVP_KAS_ECC_CDH, 0, ACVP_KAS_ECC_CURVE,
                                 ACVP_EC_CURVE_P256);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kas_ecc_set_parm(ctx, ACVP_KAS_ECC_CDH, ACVP_KAS_ECC_MODE_CDH,
                                 ACVP_KAS_ECC_CURVE, 999);
  cr_assert(rv == ACVP_INVALID_ARG);
  rv = acvp_cap_kas_ecc_set_parm(ctx, ACVP_KAS_ECC_CDH, ACVP_KAS_ECC_MODE_CDH,
                                 ACVP_KAS_ECC_CURVE, 0);
  cr_assert(rv == ACVP_INVALID_ARG);

  rv = acvp_cap_kas_ecc_enable(ctx, ACVP_KAS_ECC_COMP, &dummy_handler_success);
  cr_assert(rv == ACVP_SUCCESS);
  rv = acvp_cap_kas_ecc_set_parm(ctx, ACVP_KAS_ECC_COMP,
                                 ACVP_KAS_ECC_MODE_COMPONENT,
                                 ACVP_KAS_ECC_FUNCTION, 0);
  cr_assert(rv == ACVP_INVALID_ARG);
  ...
  // invalid cipher
  rv = acvp_cap_kas_ecc_set_scheme(
      ctx, ACVP_RSA_KEYGEN, ACVP_KAS_ECC_MODE_COMPONENT,
      ACVP_KAS_ECC_EPHEMERAL_UNIFIED, ACVP_KAS_ECC_ROLE, 0,
      ACVP_KAS_ECC_ROLE_INITIATOR);
  cr_assert(rv == ACVP_INVALID_ARG);
  // invalid mode
  rv = acvp_cap_kas_ecc_set_scheme(
      ctx, ACVP_KAS_ECC_COMP, 0, ACVP_KAS_ECC_EPHEMERAL_UNIFIED,
      ACVP_KAS_ECC_ROLE, 0, ACVP_KAS_ECC_ROLE_RESPONDER);
  cr_assert(rv == ACVP_INVALID_ARG);
  // invalid kdf set
  rv = acvp_cap_kas_ecc_set_scheme(
      ctx, ACVP_KAS_ECC_COMP, ACVP_KAS_ECC_MODE_COMPONENT,
      ACVP_KAS_ECC_EPHEMERAL_UNIFIED, ACVP_KAS_ECC_KDF, 0, 0);
  cr_assert(rv == ACVP_INVALID_ARG);
  // invalid scheme
  rv = acvp_cap_kas_ecc_set_scheme(
      ctx, ACVP_KAS_ECC_COMP, ACVP_KAS_ECC_MODE_COMPONENT, 0, ACVP_KAS_ECC_EB,
      ACVP_EC_CURVE_P224, ACVP_SHA224);
  cr_assert(rv == ACVP_INVALID_ARG);
  // invalid set
  rv = acvp_cap_kas_ecc_set_scheme(
      ctx, ACVP_KAS_ECC_COMP, ACVP_KAS_ECC_MODE_COMPONENT,
      ACVP_KAS_ECC_EPHEMERAL_UNIFIED, 0, ACVP_EC_CURVE_P256, ACVP_SHA256);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapKASFFC, invalid_params, .fini = teardown) {
  ...
  // invalid cipher
  rv = acvp_cap_kas_ffc_set_parm(
      ctx, ACVP_ECDSA_SIGGEN, ACVP_KAS_FFC_MODE_COMPONENT,
      ACVP_KAS_FFC_FUNCTION, ACVP_KAS_FFC_FUNC_DPGEN);
  cr_assert(rv == ACVP_INVALID_ARG);
  // invalid mode
  rv =
      acvp_cap_kas_ffc_set_parm(ctx, ACVP_KAS_FFC_COMP, 0,
                                ACVP_KAS_FFC_FUNCTION, ACVP_KAS_FFC_FUNC_DPVAL);
  cr_assert(rv == ACVP_INVALID_ARG);
  // invalid role
  rv = acvp_cap_kas_ffc_set_scheme(
      ctx, ACVP_KAS_FFC_COMP, ACVP_KAS_FFC_MODE_COMPONENT,
      ACVP_KAS_FFC_DH_EPHEMERAL, ACVP_KAS_FFC_ROLE, 0);
  cr_assert(rv == ACVP_INVALID_ARG);
  // invalid scheme
  rv = acvp_cap_kas_ffc_set_scheme(
      ctx, ACVP_KAS_FFC_COMP, ACVP_KAS_FFC_MODE_COMPONENT, 0, ACVP_KAS_FFC_ROLE,
      ACVP_KAS_FFC_ROLE_RESPONDER);
  cr_assert(rv == ACVP_INVALID_ARG);
}
...
Test(EnableCapKASHKDF, invalid_params, .fini = teardown) {
  ...
  rv = acvp_cap_kda_set_parm(ctx, ACVP_KDA_HKDF, ACVP_KDA_ONESTEP_AUX_FUNCTION,
                             ACVP_HASH_SHA256, NULL);
  cr_assert(rv = ACVP_INVALID_ARG);
...
Test(EnableCapKASKDFONESTEP, invalid_params, .fini = teardown) {
  ...
  rv = acvp_cap_kda_set_parm(ctx, ACVP_KDA_ONESTEP, ACVP_AES_GCM,
                             ACVP_HASH_ALG_MAX, NULL);
  cr_assert(rv = ACVP_INVALID_ARG);
  // invalid l
  ...
  rv = acvp_cap_kda_set_parm(ctx, ACVP_KDA_ONESTEP, ACVP_KDA_MAC_ALG,
                             ACVP_HASH_SHA256, NULL);
  cr_assert(rv = ACVP_INVALID_ARG);
  // invalid alg calls to set_domain
  rv = acvp_cap_kda_set_domain(ctx, ACVP_HASH_SHA256, ACVP_KDA_Z, 0, 4096, 8);
